                ...
                <View style={{ flex: 1, justifyContent: 'center' }}>
                    <ModalContainer bottomRadius style={{ margin: 31 }} margin={31}>
                        <View style={{ borderTopLeftRadius: 47, borderTopRightRadius: 47, overflow: 'hidden', width: '100%' }}>
                            <Image source={{uri: this.props.link}} resizeMode={'cover'} style={{ height: 130 }} />
                        </View>
                        <View style={{ paddingHorizontal: 24, paddingBottom: 32, paddingTop: 32 }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <Image source={require('../source/avatar.png')} style={styles.image} />
                                <View style={{ flex: 1 }}>
                                    <View>
                                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                            <Text style={styles.name}>Александр</Text>
                                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                <Text style={{ fontFamily: 'Gilroy-Regular' }}>150₽</Text>
                                                <Image source={require('../source/icons/icon-black-cash.png')} resizeMode={'contain'} style={{ width: 24, height: 24, marginLeft: 4 }} />
                                            </View>
                                        </View>
